...
int count_sale_h = 0 ;
int employee_count_h = 0;
int employee_count = 0 ;
int customer_count_h = 0 ;
int sale_count =  0 ;
int count_stock_h = 0 ;
...
{
	int choice , i = 0, j  ;
	int stock_count = 0, sale_count= 0, employee_count= 0 ;
		...
		/*	cout << "Press 3 to Sell a Part." << endl;
			...
			switch( choice )
			{
					case 1 :
							...
							{
									//cout<< "Found Model Id : test"; test Successfull
